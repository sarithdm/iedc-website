...
2. **Configure Blueprint**:
   ...
   - Review the services that will be created:
     ...
     - `iedc-website` (Frontend Static Site)

3. **Set Environment Variables**:
   - For `iedc-api-server`, add all the backend environment variables listed above
   - The frontend environment variables will be set automatically
